...
#SBATCH --error=./err/07.pra/VD_AMG_%A_%a.err
#SBATCH --output=./out/07.pra/VD_AMG_%A_%a.out
#SBATCH --mem=32gb
...
#	-U ../SAMPLES/${SAMPLE_ID}/clean_reads/${SAMPLE_ID}_ECC_unmatched.fastq.gz \
#	--no-unal \
#	--threads ${SLURM_CPUS_PER_TASK} \
#	-S ${TMPDIR}/${SAMPLE_ID}/ALIGN/${SAMPLE_ID}.sam \
#	&> ../SAMPLES/${SAMPLE_ID}/paired_to_all.cont.bowtie2.log
