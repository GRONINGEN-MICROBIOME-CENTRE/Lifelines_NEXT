...
sed -i 's/^\([^_]*_[^_]*_[^_]*_[^_]*_\)/>/' ${TMPDIR}/${SAMPLE_ID}/COBRA/${SAMPLE_ID}_all_predicted_viral.fasta
...
bowtie2 \
	...
	-1 ../SAMPLES/${SAMPLE_ID}/clean_reads/${SAMPLE_ID}_ECC_paired_1.fastq.gz \
	-2 ../SAMPLES/${SAMPLE_ID}/clean_reads/${SAMPLE_ID}_ECC_paired_2.fastq.gz \
	--no-unal \
...
coverm contig \
	--coupled ../SAMPLES/${SAMPLE_ID}/clean_reads/${SAMPLE_ID}_ECC_paired_1.fastq.gz ../SAMPLES/${SAMPLE_ID}/clean_reads/${SAMPLE_ID}_ECC_paired_2.fastq.gz \
