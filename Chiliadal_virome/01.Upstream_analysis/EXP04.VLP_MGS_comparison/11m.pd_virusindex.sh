...
#SBATCH --output=./out/10.mvin/PD_vir_index_N_vir_genes.out
#SBATCH --mem=48gb
...
mkdir -p ../VIR_DB/mapping/VLP_MGS_overlap/alignment_log
mkdir -p ../VIR_DB/mapping/VLP_MGS_overlap/coverage
mkdir -p ../VIR_DB/mapping/VLP_MGS_overlap/bams
module purge
