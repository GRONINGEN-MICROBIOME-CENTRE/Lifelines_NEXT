...
pathways_1 <- pathways[match(rownames(infant_metadata_dynamic_phenotypes_2), rownames(pathways)), , drop = FALSE]


# Select merged phenotype & metadata file 
phenotypes<-infant_metadata_dynamic_phenotypes_2
...
setwd("/Users/trishlasinha/Desktop/LLNEXT/Analysis/results/pathways/infants")
write.table(result_pathways, "pathways_GAM_infants_dynamic_phenotypes.txt", sep = "\t", row.names = F)


setwd("/Users/trishlasinha/Desktop/LLNEXT/Analysis/results/alpha_diversity/infants/")

write.table(result_alpha, "alpha_diversity_GAM_infants_dynamic_phenotypes_without_correction.txt", sep = "\t", row.names = F)

setwd("/Users/trishlasinha/Desktop/LLNEXT/Analysis/results/taxa/infants/")

write.table(result_taxa, "taxa_GAM_infants_dynamic_phenotypes.txt", sep = "\t", row.names = F)
