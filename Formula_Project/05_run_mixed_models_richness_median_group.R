...
exclude_columns <- c("median_group_energy_kcal", "median_group_X3_GL_galactosyllactose_mg", "median_group_casein_g")
...
saveRDS(res_median_richness, file = here("scripts/GITHUB/output/association_analysis_results_richness_birth_mode", "df_association_analysis_median_richness_birth_mode_final.rds"))


res <- res_median_richness %>% filter(p_value<0.05)
...
saveRDS(res_median_richness_sig_BH, file = here("output/association_analysis_results_richness_birth_mode", "df_significant_median_richness_BH_corrected.rds"))
