...
#	-1 ../SAMPLES/${SAMPLE_ID}/raw_reads/${SAMPLE_ID}_1.fastq.gz \
#	-2 ../SAMPLES/${SAMPLE_ID}/raw_reads/${SAMPLE_ID}_2.fastq.gz \
#	-U ../SAMPLES/${SAMPLE_ID}/raw_reads/${SAMPLE_ID}.fastq.gz \
#	--no-unal \
